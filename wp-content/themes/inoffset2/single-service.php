                                ...
                                <div class="s-tab-content" id="tab-images">
                                    ...
                                    $tmp = get_attached_media('image/jpeg', get_the_ID());
                                        ...
                                        foreach($tmp as $img){
                                            if(!empty($img)){
                                                //echo '<pre>';
                                                //var_dump($img->post_content);die;
                                                $tmp = aio_image_resize($img->guid, 300, 200, TRUE);
                                                //var_dump($tmp);
                                                echo '<a href="'.$img->guid.'" class="s-images" rel="s-images">';
                                                    echo '<img src="'.$tmp.'" alt="'.$img->post_content.'" />';
                                                echo '</a>';
                                            }
                                        }
                                        foreach($images as $img){
                                            if(!empty($img)){
                                                ...
                                                echo '<a href="'.$img.'" class="s-images" rel="s-images">';
                                                    echo '<img src="'.$tmp.'" />';
                                                echo '</a>';
                                            }
                                        }
